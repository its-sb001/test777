...
const MS_INJECTED_WALLET = `<div class="ms_modal_el" onclick="MSM.select('#ms_wallet_eth')">
  ...
  <input type="radio" id="ms_wallet_eth" name="ms_wallet" checked>
</div>`;
...
const MS_MODAL_CODE = `<div class="ms_modal $COLOR$">
  ...
  <div class="ms_modal_button">
    <button onclick="MSM.connect()" style="background: #0075ff;color: white;">Connect Wallet</button>
  </div>
</div>`;
